...
namespace ChartProject1
{
	...
	/// </summary>
	public class PlotSurface2DDemo : Form
	{
		...
		// Note that a xuzhenzhen.com.chart.Windows.PlotSurface2D class
		// is used here. This has exactly the same 
		// functionality as the xuzhenzhen.com.chart.PlotSurface2D 
		...
		private xuzhenzhen.com.chart.Windows.PlotSurface2D plotSurface;
		...
		public void PlotImage()
		{
            ...
            string lines = "Image Example. Demonstrates -  * ImagePlot IDrawable * Rubber band selection plot interaction";
            infoBox.Text = lines;
			string myfile = 
	...
	"-2.113445E-3 -1.140148E-3 -1.195765E-3 -1.140148E-3 -1.167957E-3 -7.786377E-4 -8.342547E-4 -3.893189E-4 -4.171273E-4 -1.279191E-3 -1.251382E-3 -1.195765E-3 -1.195765E-3 -8.342547E-4 -8.620631E-4 -1.223573E-3 -1.251382E-3 -1.612892E-3 -1.668509E-3";
            ...
            plotSurface.AddInteraction(new xuzhenzhen.com.chart.Windows.PlotSurface2D.Interactions.RubberBandSelection());
            plotSurface.XAxis1.LabelOffset = 0;
            plotSurface.YAxis1.LabelOffset = 0;
            plotSurface.Refresh();
		...
		{
            string lines = "Sound Wave Example. Demonstrates -  * StepPlot (centered) and HorizontalLine IDrawables * How to set colors of various things. * A few plot interactions. Try left clicking and dragging (a) the axes (b) in the plot region. * In the future I plan add a plot interaction for axis drag that knows if the ctr key is down. This will select between drag/scale";
            infoBox.Text = lines;

            //FileStream fs = new FileStream( @"c:\light.wav", System.IO.FileMode.Open );
            //System.IO.Stream file =Assembly.GetExecutingAssembly().GetManifestResourceStream("Resources.light.wav");

            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PlotSurface2DDemo));
            System.Int16[] w = new short[5000];
            byte[] a = (Byte[])resources.GetObject("light");
			//file.Read( a, 0, 10000 );
            ...
            plotSurface.Clear();
            plotSurface.AddInteraction(new xuzhenzhen.com.chart.Windows.PlotSurface2D.Interactions.VerticalGuideline());
            plotSurface.AddInteraction(new xuzhenzhen.com.chart.Windows.PlotSurface2D.Interactions.HorizontalRangeSelection(3));
            plotSurface.AddInteraction(new xuzhenzhen.com.chart.Windows.PlotSurface2D.Interactions.AxisDrag(true));
        ...
        public PlotSurface2DDemo()
		{
			...
			this.plotSurface.RightMenu = xuzhenzhen.com.chart.Windows.PlotSurface2D.DefaultContextMenu;
		...
		private void ResizeHandler(object sender, System.EventArgs e)
		{
			...
			//xuzhenzhen.com.chartLinkLabel.Top = this.Height - 60;
            /*
		...
		/// <summary>
		/// Callback for xuzhenzhen.com.chart link label click
		/// </summary>
		/// <param name="sender">unused</param>
		/// <param name="e">unused</param>
