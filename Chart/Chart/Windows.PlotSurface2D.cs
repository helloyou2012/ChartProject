...
namespace xuzhenzhen.com.chart.Windows
{
	...
	public class PlotSurface2D : System.Windows.Forms.Control, IPlotSurface2D, ISurface
	{
        ...
        private xuzhenzhen.com.chart.PlotSurface2D ps_;
		...
		public void DoPaint( PaintEventArgs pe, int width, int height )
		{
			...
			if ( ps_ == null )
			{
                throw (new NPlotException("null xuzhenzhen.com.chart.PlotSurface2D"));
			}
		...
		public void Add( IDrawable p, xuzhenzhen.com.chart.PlotSurface2D.XAxisPosition xp, xuzhenzhen.com.chart.PlotSurface2D.YAxisPosition yp )
		{
			ps_.Add( p, xp, yp );
		}
		...
		/// <param name="yp">the y-axis to add the plot against.</param>
		/// <param name="zOrder">The z-ordering when drawing (objects with lower numbers are drawn first)</param>
		public void Add( IDrawable p, xuzhenzhen.com.chart.PlotSurface2D.XAxisPosition xp,
			xuzhenzhen.com.chart.PlotSurface2D.YAxisPosition yp, int zOrder )
		{
		...
		/// </summary>
		public xuzhenzhen.com.chart.Legend Legend
		{
			get
			{
				return ps_.Legend;
        ...
        public void DrawToBitmap(System.Drawing.Bitmap bi,Rectangle rec)
        {
            System.Drawing.Graphics g = Graphics.FromImage(bi);
            this.Draw(g, rec);
        }
		...
		/// xuzhenzhen.com.chart.Windows.PlotSurface2D.ContextMenu.
		/// </summary>
		public xuzhenzhen.com.chart.Windows.PlotSurface2D.PlotContextMenu RightMenu
		{
			get
			{
				return rightMenu_;
		...
		private xuzhenzhen.com.chart.Windows.PlotSurface2D.PlotContextMenu rightMenu_ = null;


		/// <summary>
		/// Gets an instance of a xuzhenzhen.com.chart.Windows.PlotSurface2D.ContextMenu that
		...
		public static PlotContextMenu DefaultContextMenu
		{
			get
			{
				return new xuzhenzhen.com.chart.Windows.PlotSurface2D.PlotContextMenu();
			}
		}
        ...
        /// </summary>
        public xuzhenzhen.com.chart.PlotSurface2D Inner
        {
            get
            {
                return ps_;
        ...
        public abstract class Interactions
        {
            ...
            public class VerticalGuideline : Interaction
            {
                ...
                /// <param name="ctr"></param>
                /// <param name="lastKeyEventArgs"></param>
                public override bool DoMouseDown(MouseEventArgs e, System.Windows.Forms.Control ctr)
                {
                    xuzhenzhen.com.chart.PlotSurface2D ps = ((Windows.PlotSurface2D)ctr).Inner;
                    Point here = new Point(e.X, e.Y);
                    if (ps.PlotAreaBoundingBoxCache.Contains(here))
                    {
                        if (((Windows.PlotSurface2D)ctr).PhysicalXAxis1Cache == null)
                            return false;
                        double x = ((Windows.PlotSurface2D)ctr).PhysicalXAxis1Cache.PhysicalToWorld(here, true);
                        foreach (IDrawable drawable in ps.Drawables)
                        {
                            if (drawable is VerticalLine)
                            {
                                VerticalLine line = (VerticalLine)drawable;
                                line.AbscissaValue = x;
                                ((Windows.PlotSurface2D)ctr).InteractionOccured(this);
                                return true;
                            }
                        }
            ...
            public class HorizontalDrag : Interaction
            {
                ...
                public override bool DoMouseMove(MouseEventArgs e, Control ctr, KeyEventArgs lastKeyEventArgs)
                {
					...
					if ((e.Button == MouseButtons.Left) && dragInitiated_)
					{
						...
						{
							Axis axis = ps.XAxis1;
							PointF pMin = new PointF(ps.PhysicalXAxis1Cache.PhysicalMin.X,ps.PhysicalXAxis1Cache.PhysicalMin.Y);
							PointF pMax = new PointF(ps.PhysicalXAxis1Cache.PhysicalMax.X,ps.PhysicalXAxis1Cache.PhysicalMax.Y);
                ...
                public override bool DoMouseMove(MouseEventArgs e, Control ctr, KeyEventArgs lastKeyEventArgs)
                {
					...
					if ((e.Button == MouseButtons.Left) && doing_ && physicalAxis_ != null)
                    {
						...
						else
						{
							...
							PointF pMin = new PointF(physicalAxis_.PhysicalMin.X,physicalAxis_.PhysicalMin.Y);
							PointF pMax = new PointF(physicalAxis_.PhysicalMax.X,physicalAxis_.PhysicalMax.Y);
