...
namespace xuzhenzhen.com.chart
{
	...
	public class PlotSurface2D : IPlotSurface2D
	{
		...
		public void Draw( Graphics g, Rectangle bounds )
		{
			...
			{
                Image image = Utils.TiledImage(this.plotBackImage_, new Size(((Rectangle)plotAreaBoundingBoxCache_).Width, ((Rectangle)plotAreaBoundingBoxCache_).Height));
				//g.DrawImage( Utils.TiledImage( this.plotBackImage_ , new Size( ((Rectangle)plotAreaBoundingBoxCache_).Width,((Rectangle)plotAreaBoundingBoxCache_).Height ) ), (Rectangle)plotAreaBoundingBoxCache_ );
                g.DrawImage(image, (Rectangle)plotAreaBoundingBoxCache_, (Rectangle)plotAreaBoundingBoxCache_, GraphicsUnit.Pixel);
			}
