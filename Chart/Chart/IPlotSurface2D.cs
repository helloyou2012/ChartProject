...
namespace xuzhenzhen.com.chart
{
	...
	public interface IPlotSurface2D
	{
		...
		/// <param name="zOrder">The z-ordering when drawing (objects with lower numbers are drawn first)</param>
        void Add(IDrawable p, xuzhenzhen.com.chart.PlotSurface2D.XAxisPosition xp, xuzhenzhen.com.chart.PlotSurface2D.YAxisPosition yp, int zOrder);
        ...
        void Add(IDrawable p, xuzhenzhen.com.chart.PlotSurface2D.XAxisPosition xax, xuzhenzhen.com.chart.PlotSurface2D.YAxisPosition yax);
		...
		/// </summary>
		xuzhenzhen.com.chart.Legend Legend { get; set; }
